...
const ClientDetails = ({ user }) => {
  return (
    <div className=" dark:-dark dark:bg-opacity-25   dark:text-white mt-16  p-2  bg-gradient-to-r from-green-50  to-slate-50 border rounded-md dark:border-main   border-x-0 mx-7 dark:bg-gradient-to-r dark:from-main  dark:to-main-dark md:w-fit">
