...
<>
         <h2 className=" flex flex-col items-center justify-center gap-0  dark:text-accent-dark text-xlw-fit p-1 md:p-3 rounded-full text-2xl md:text-3xl  font-semibold pt-20  md:mt-16 mb-6 text-main ">
            <HardHat className='animate-pulse'  /> Proposals
          </h2>
        <div className='w-full lg:w-11/12  mx-auto md:p-4 p-1 lg:p-8 h-screen  rounded-md '>
    ...
    <div
        key={index}
        className=" dark:bg-main  dark:bg-opacity-25  p-4 md:p-5  rounded-lg hover:shadow-lg shadow-md transition-all duration-300 ease-in-out transform hover:-translate-y-1 border border-main dark:border-main"
    >
        <div className="text-base md:text-lg  flex flex-col">
            <div className="flex flex-col md:flex-row mb-0">
              <p className='md:hidden inline-block bg-gradient-to-r from-green-100 to-slate-200 dark:from-teal-900 dark:to-main-dark dark:text-white w-fit pr-2 pl-1 rounded-md '>Cover Latter</p>
                <span className='hidden md:w-20 w-36 mr-3 md:inline-block md:pt-4 lg:pt-0'>
                    <img src={engineers} alt="cover letter" />
                </span>
                <p className="mt-2 break-all dark:text-white text-sm md:text-base ">{proposal.coverLetter}</p>
...
<div className='order-1 md:order-2 md:mb-0 mb-1.5'>
        <div className="text-nowrap  flex  justify-center items-center dark:text-white text-sm md:text-base">
           <p className='w-fit  pb-0  p-2 rounded-md '> <span className='inline-block pr-1'>Cost:</span> {proposal.totalCost} EGP</p>
        </div>
        ...
        <div className="flex  justify-center gap-1 items-center pt-1  my-0 mx-1 ">
            ...
            <Button 
                ...
                onClick={() => handleReject(index)}
                 className=" md:w-1/5 w-full text-red-700 md:text-xl text-base  bg-red-300 hover:bg-red-400 border-red-100 border   hover:border-red-200 order-3 "
