  ...
  return (
    <div className=" min-h-screen">
      {isLoading ? (
        ...
        <div className="container mx-auto p-4 px-4   dark:text-text-dark md:px-20 mb-12">
          ...
          {engineerProposals.proposal.map((proposal) => (
            <div
              key={proposal._id}
              className="bg-white dark:bg-main-dark  dark:text-white shadow-lg rounded-xl mb-8 p-8 w-full transform hover:-translate-y-2 transition duration-300 ease-in-out"
            >
              <h2 className="text-2xl font-semibold mb-4  dark:text-white text-main">
                <span className="text-gray-600  dark:text-accent ">Job Title: </span>
      ...
      {selectedProposal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-main-dark  dark:text-text-dark rounded-lg p-8 max-w-md w-full">
            ...
            <h4 className="text-xl font-semibold mb-2  dark:text-accent">Job Details</h4>
            <p className="mb-2">
